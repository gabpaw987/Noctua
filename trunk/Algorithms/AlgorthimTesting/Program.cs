...
namespace AlgorthimTesting
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            asd = CSVReader.EnumerateExcelFile("C:/Users/Josefs/Documents/Schule/PPM/noctua/trunk/Input_Data/COMPQ_1dBar_20130220kurz.csv", new DateTime(), DateTime.Now).ToList();
