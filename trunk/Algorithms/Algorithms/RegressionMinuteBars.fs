...
//            signals.Add(0)
            //for longterm trends
            let regression40 = Array.append (Array.zeroCreate(40)) [|for i in 40 .. prices.Length - 1 do yield 100m * regression([|for j in i - 40 .. i do yield values.[j]|])|]
//            for i in osz.["80;#FF0000"].Count .. regression80.Length - 1 do osz.["80;#FF0000"].Add(regression80.[i])
            //confirms the regression90
            let regression10 = Array.append (Array.zeroCreate(10)) [|for i in 10 .. prices.Length - 1 do yield 100m * regression([|for j in i - 10 .. i do yield values.[j]|])|]
            for i in osz.["60;#00FF00"].Count .. regression10.Length - 1 do osz.["60;#00FF00"].Add(100m * regression10.[i])
...
//            for i in osz.["30;#FFFF00"].Count .. regression30.Length - 1 do osz.["30;#FFFF00"].Add(regression30.[i])
            ...
            for i in osz.["20;#000000"].Count .. regression8.Length - 1 do osz.["20;#000000"].Add(100m * regression8.[i])
            ...
            for i in osz.["10;#0000FF"].Count .. regression5.Length - 1 do osz.["10;#0000FF"].Add(100m * regression5.[i])
...
//            for i in osz.["5;#0000FF"].Count .. regression5.Length - 1 do osz.["5;#0000FF"].Add(regression5.[i])
            ...
            for i in osz.["2;#FF0000"].Count .. regression2.Length - 1 do osz.["2;#FF0000"].Add(100m * regression2.[i])
            for i in 0 .. prices.Length - 1 do 
                signals.Add(0)

//                // long trending
                if regression40.[i] > 2m || regression40.[i] < -2m then
...
//                    lowestk <- 0m  
        ...
        let startCalculation (list2D:System.Collections.Generic.List<System.Tuple<System.DateTime, decimal, decimal, decimal, decimal>>,signals:System.Collections.Generic.List<int>, ind:System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<decimal>>, osz:System.Collections.Generic.Dictionary<string, System.Collections.Generic.List<decimal>>)= 
            let a = signals.Clear
            if osz.Count = 0 then 
                osz.Add("80;#FF0000",new System.Collections.Generic.List<decimal>())
