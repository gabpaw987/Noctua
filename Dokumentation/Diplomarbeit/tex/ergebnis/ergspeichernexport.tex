...
Sowohl das Speichern und Laden als auch das Exportieren benützen spezielle FileDialogs (\textit{OpenFileDialog} und \textit{SaveFileDialog}) zur Auswahl der zu ladenden Datei bzw. des gewünschten Speicherorts der Datei. Diese FileDialog sieht bspw. beim Speichern eines .bts-Files aus wie in Abbildung \ref{fig:bts_speichern}.\\
