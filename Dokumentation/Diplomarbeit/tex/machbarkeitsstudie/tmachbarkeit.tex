...
Nach dem Festlegen der verwendeten Programmiersprachen ist es nun auch möglich in C\# zwischen zwei verschiedenen Grafikframeworks für die GUI der \gls{bts} auszuwählen, weil Windows Presentation Foundation (WPF) neuer ist und Windows Forms (WF) nicht auf dem Model-View-Control-Pattern (MVC) basiert, wird das Framework WPF angewendet.

\subsubsection{Backtesting-Software}
