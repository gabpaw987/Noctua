...
\begin{itemize}
\item \textbf{Net Worth} \\
	Hier ist der Net Worth das gesamte Kapital, das man  nach dem Einsatz des Algorithmus über die gesamte gewählte Periode besessen hätte. Es berechnet sich aus den Gewinnen und Verlusten aus allen Trades und dem Startkapital. Der Net Worth ist daher außerdem gleich mit dem Order-spezifischen Net Worth nach der letzten Order.
\item \textbf{Portfolio Performance [\%]} \\
...
\item \textbf{Ratio of Good Trades - Bad Trades} \\
	Der Ratio zwischen Good und Bad Trades beschreibt deren mengenmäßiges Verhältnis. Dabei wird die Anzahl an Good Trades durch die Anzahl an Bad Trades dividiert. Dadurch entsteht quasi ein Wirkungsgrad, bei dem Ergebnisse größer als 1 darauf hindeuten, dass mehr Good Trades als Bad Trades vom Algorithmus berechnet wurden. Die Berechnung funktioniert wie folgt:
	\begin{equation}
