...
Ein \gls{ama}, also ein \gls{ema} mit variabler Länge benötigt wurde in F-\# folgendermaßen implementiert (ama-Methode)
und benötigt einen Aufruf der Methoden zur Berechnung des Efficiency Ratio (er) und der Anpassung des ER an die gegebenen Periodenspanne (c)  je AMA-Wert.
