...
\item \textbf{\textit{LoadFile}} \\
	Die \textit{LoadFile}-Methode erfüllt nahezu den gleichen Zweck, wie die \textit{LoadFrom}-Methode, nur dass man hier einfach eine zweite Assembly in die Domäne laden kann und die erste wird überschrieben. Daher wird in der \gls{bts} diese Methode genutzt.
\end{itemize}
