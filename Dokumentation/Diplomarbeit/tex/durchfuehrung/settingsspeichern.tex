...
Die daraus resultierende \inline{StringCollection} kann natürlich auch in die Anwendungskonfigurationsdatei gespeichert werden. Beim Auslesen können die \inline{StackPanel}s wie folgt wieder aufgebaut werden:
