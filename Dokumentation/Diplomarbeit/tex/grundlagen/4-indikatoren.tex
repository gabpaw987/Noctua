...
\begin{enumerate}
	\item{Directional Movement ($DM_+$, $DM_-$) berechnen\\
		...
		$DM_+$ ist dabei die Spanne darüber, $DM_-$ jene darüber. Der $DM$ ist dabei immer positiv, es wird also der Betrag der Differenz verwendet. (siehe Abbildung \ref{fig:dm})}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Relative Strength Index} \label{subsubsection:rsi}
