...
Um die Software zu bedienen, wird ein in F\# geschriebener Algorithmus benötigt. Dieser muss als gls{DLL}-Datei zur Laufzeit in die Software eingebunden werden. Eine solche Datei wird mittels Microsoft Visual Studio erzeugt werden, damit die Software funktionieren kann. \\
