...
\subsection{Backtestingsoftware}

Die \gls{BTS} ist nun also die Kernsoftware, mit der die Algorithmen über Daten-Files getestet werden können. Dazu sollten zuerst die allgemeinen Einstellungen vorgenommen werden. Diese befinden sich im Settings-Tab unter "`Orders"' und sehen so aus:
...
Nachdem alle Einstellungen vorgenommen wurden, kann der Test gestartet werden. \\

\begin{figure}[!h]
\centering
\includegraphics[width=0.5\textwidth]{images/btsstart.png}
